...
A fork of [slideshow](https://github.com/rse/slideshow) by Dr. Ralf S. Engelschall, modified to modernize the codebase while maintaining the API interface. CLI functionality has been removed.

Abstract
--------

Slideshow-redux is a [Node](http://nodejs.org/)/JavaScript Application Programming Interface
(API) for observing and controlling slideshow presentation applications
...
```js
//  API usage example
var SlideShow = require("slideshow-redux")
...
This project is a fork of [slideshow](https://github.com/rse/slideshow) by Dr. Ralf S. Engelschall.

Original work Copyright (c) 2014-2023 Dr. Ralf S. Engelschall <http://engelschall.com>
Modified work Copyright (c) [YEAR] [YOUR NAME]
